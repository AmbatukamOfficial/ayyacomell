...
const second = 1000,
  ...
  hour = minute * 888,
  day = hour * 24;
let countDown = new Date('Jul 23, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hari ini adalah hari yang sangat spesial, karena seseorang yang aku cintai lahir ke dunia.", "Terimakasih sudah menjadi bagian terindah dalam hidupku.", "Semoga ulang tahunmu di penuhi dengan kebahagiaan, cinta, dan semua impianmu tercapai.", "Aku akan selalu ada disini untuk mendukung dan mencintaimu, hari ini dan selamanya ." , "Selamat ulang tahun sayang! (Maya Cantikku, Maniskuuu, Comellkuuu, Lopyu Poreper Deh!)."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Mohon maaf ya om, aku gak bisa kasih apa-apa dan aku gak seperti yang kamu mau, tapiii... aku tuh dari kemarin mikir mau kasih kado apaaa.", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini. dan aku tau kadonya itu apa? kadonya adalah HATI YANG SETIA", " ", "- Wish all you the best Maya Comellkuuu, hehehe, Maap ya kalau jelek!"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
